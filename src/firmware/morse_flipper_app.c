...
MorseFlipperApp* morse_flipper_boot(void)
{
    ...
    app = (MorseFlipperApp){
        ...
        .rf_monitor_threshold_dbm = -85,
        .rf_rssi_samples = 0U,
        .rf_rx_edges_window = 0U,
        .rf_rx_activity = 0U,
        .ham_macro_active = false,
        .ham_macro_mark = false,
        .ham_macro_char_idx = 0U,
        .ham_macro_mark_idx = 0U,
        .ham_macro_dir = MORSE_FLIPPER_HAM_KEYER_UNASSIGNED,
        .ham_macro_next_at = 0U,
        .ham_notice_until = 0U,
        .rf_rx_text = {0},
        .rf_tx_text = {0},
        .gpio_text = {0},
