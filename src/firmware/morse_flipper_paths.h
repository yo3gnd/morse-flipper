...
#define MORSE_FLIPPER_STRAIGHT_STATS_PATH EXT_PATH("ham/morse-flipper-straight-stats.txt")
...
#define MORSE_FLIPPER_STRAIGHT_STATS_PATH "ext/ham/morse-flipper-straight-stats.txt"
