...
#define MORSE_FLIPPER_ONBOARDING_PATH \
    MORSE_FLIPPER_APP_DATA_DIR "/onboarding.flag"
#define MORSE_FLIPPER_PROGRESS_PATH MORSE_FLIPPER_APP_DATA_DIR "/progress.bin"
#define MORSE_FLIPPER_PROGRESS_HISTORY_DIR \
    MORSE_FLIPPER_APP_DATA_DIR "/history"
